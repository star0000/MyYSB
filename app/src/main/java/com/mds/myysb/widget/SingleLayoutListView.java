...
public class SingleLayoutListView {
...
//                break;
//            case DONE:
//                // MLog.showLogWithLineNum(3, "changeHeaderViewByState ===>  DONE");
//
//                mHeadRootView.setPadding(0, -1 * mHeadViewHeight, 0, 0);
//
//                mProgressBar.setVisibility(View.GONE);
