...
public class ChooseYCQCustomDatePicker implements View.OnClickListener, PickerView.OnSelectListener{
     ...
     */
    public ChooseYCQCustomDatePicker(Context context, CustomDatePicker.Callback callback, String beginDateStr, String endDateStr) {
     ...
     */
    public ChooseYCQCustomDatePicker(Context context, CustomDatePicker.Callback callback, long beginTimestamp, long endTimestamp) {
    ...
    private void initView() {
        ...
        mPickerDialog.setContentView(R.layout.date_ycq_choose_dialog);
        ...
        mPickerDialog.findViewById(R.id.btn_sure).setOnClickListener(this);
        mPickerDialog.findViewById(R.id.date_choose_back).setOnClickListener(this);
