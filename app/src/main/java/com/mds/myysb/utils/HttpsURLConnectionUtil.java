...
public class HttpsURLConnectionUtil {
    ...
    private static final String APPKEY = "SessionId";
    ...
    public static HttpURLConnection CreatePostHttpConnection( String sessionId, String uri, String contentType) throws MalformedURLException, IOException, ProtocolException {
        String appSecret = "MdsylsbJk";
        String nonce = String.valueOf(Math.random() * 1000000);
        String timestamp = String.valueOf(System.currentTimeMillis() / 1000);
        StringBuilder toSign = new StringBuilder(appSecret).append(sessionId).append(nonce).append(timestamp);
        ...
        conn.setRequestProperty(APPKEY,sessionId);
